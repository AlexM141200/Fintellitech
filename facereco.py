            ...
            for self.i in self.labels_ids:
                ...
                for imgNo in range(1, (noOfImgs+1)):
                    self.directory = os.path.join(
                        self.image_dir, self.i, str(imgNo)+'.png')
                    self.img = face_recognition.load_image_file(self.directory)
                    self.img_encoding = face_recognition.face_encodings(self.img)[
                        0]
                ...
                for self.face_encoding in self.face_encodings:
                    ...
                    for self.face in self.known_faces:
                        ...
                        self.matches = face_recognition.compare_faces(
                            [self.face[1]], self.face_encoding)
                        print(self.matches)
                        self.name = 'Unknown'
                        ...
                        print('This is the match in best match',
                              self.matches[self.best_match])
